...
/**
 * Returns a selector for the `data-test` attribute with the given attribute value.
 *
 * @param testId Test id set by `data-test`
 *
 */
...
/**
 * Finds an element inside the Component by the given `data-test` attribute.
 * Throws an error if no element was found.
 *
 * @param fixture Component fixture
 * @param testId Test id set by `data-test`
...
/**
 * Finds all elements with the given `data-test` attribute.
 *
 * @param fixture Component fixture
 * @param testId Test id set by `data-test`
 */
...
/**
 * Gets the text content of an element with the given `data-test` attribute.
 *
 * @param fixture Component fixture
 * @param testId Test id set by `data-test`
 */
...
/**
 * Expects that the element with the given `data-test` attribute
...
/**
 * Sets the value of a form field with the given `data-test` attribute.
 *
 * @param fixture Component fixture
 * @param testId Test id set by `data-test`
 * @param value Form field value
...
/**
 * Emulates a left click on the element with the given `data-test` attribute.
 *
 * @param fixture Component fixture
 * @param testId Test id set by `data-test`
 */
 ...
 * When finding other elements, use `findEl` / `findEls` and `data-test` attributes.
 *
